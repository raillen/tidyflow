...
public class JsonLocalizationService : ILocalizationService, INotifyPropertyChanged
{
    ...
    private Dictionary<string, string> GetPtBrDefaults() => new() {
        ...
        ["FolderBlueprint"] = "Planta de Pastas",
        ["AddFolder"] = "Adicionar Pasta",
        ["RenameTemplateLabel"] = "Template de Nomes",
        ["TokensAvailable"] = "Tokens: {Date}, {JobName}, {FileName}, {Ext}, {Parent}",
        ["EnableOrganization"] = "Ativar Blueprint",
        ["BlueprintDesc"] = "Regras para organizar pastas no local",
        ["BlueprintHub"] = "Centro de Blueprint",
