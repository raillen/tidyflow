...
public class JsonLocalizationService : ILocalizationService, INotifyPropertyChanged
{
    ...
    private Dictionary<string, string> GetEnUsDefaults() => new() {
        ...
        ["InterfaceFont"] = "Interface Font", ["Default"] = "Default (Inter)", ["System"] = "System Default",
        ["AboutAutoFlow"] = "About AutoFlow", ["AboutDescription"] = "AutoFlow was born to simplify backup management and large-scale file organization, joining industrial performance with a modern and intuitive interface.",
        ["DevelopedBy"] = "Developed by Raillen Santos", ["DeveloperBio"] = "Professionally active at the intersection of Marketing and Design, I am a technology enthusiast driven by technical curiosity. With a solid foundation in web technologies and automation, I seek to unite aesthetics and functionality to create solutions that simplify daily life and boost results.",
        ["ViewChangelog"] = "View Changelog", ["ChangelogTitle"] = "Version Notes", ["ChangelogSubtitle"] = "Follow the evolution of AutoFlow Pro",
        ["EndRecentHistory"] = "End of recent history.", ["GotIt"] = "Got it",
        ["Changelog_v1_4_1"] = "• **Dashboard Responsiveness**: UniformGrid and TextTrimming implemented in metrics cards to prevent breakage.\n• **Quick Actions in Flows**: New shortcuts for manual and monitored tasks in the Automation module.\n• **Audit Improvements**: New detail layout for operation logs, fixing text clipping issues.\n• **Smart Navigation**: Visual highlight (background and color) for the active tab in the sidebar.",
        ["Changelog_v1_4_0"] = "• **Customizable Typography**: Support for multiple fonts (Inter, Roboto, Montserrat, Open Sans, Public Sans, and JetBrains Mono).\n• **Real-time Adjustments**: Theme, font, and visual effect changes are applied instantly without restarting.\n• **Mica & Glass Effect**: Native support for Windows 11 Mica and AcrylicBlur with variable opacity slider for the sidebar.\n• **UI Stability**: Minimum window size (950x650) defined to ensure visual integrity.",
        ...
        ["RamUsageFormat"] = "{0} MB / {1} GB", ["TimeSavedFormat"] = "{0}h {1}m", ["SchedulerLoopError"] = "Scheduler error: {0}",
    ...
    private Dictionary<string, string> GetPtBrDefaults() => new() {
        ...
        ["InterfaceFont"] = "Fonte da Interface", ["Default"] = "Padrão (Inter)", ["System"] = "Padrão do Sistema",
        ["AboutAutoFlow"] = "Sobre o AutoFlow", ["AboutDescription"] = "O AutoFlow nasceu para simplificar o gerenciamento de backups e a organização de arquivos em larga escala, unindo performance industrial com uma interface moderna e intuitiva.",
        ["DevelopedBy"] = "Desenvolvido por Raillen Santos", ["DeveloperBio"] = "Atuando profissionalmente na intersecção entre Marketing e Design, sou um entusiasta da tecnologia movido pela curiosidade técnica. Com uma base sólida em desenvolvimento web e automação, busco unir estética e funcionalidade para criar soluções que simplificam o cotidiano e potencializam resultados.",
        ["ViewChangelog"] = "Ver Changelog", ["ChangelogTitle"] = "Notas da Versão", ["ChangelogSubtitle"] = "Acompanhe a evolução do AutoFlow Pro",
        ["EndRecentHistory"] = "Fim do histórico recente.", ["GotIt"] = "Entendido",
        ["Changelog_v1_4_1"] = "• **Responsividade do Dashboard**: Implementado UniformGrid e TextTrimming nos cards de métricas para evitar quebras.\n• **Ações Rápidas em Fluxos**: Novos atalhos para criação de tarefas manuais e monitoradas no módulo de Automação.\n• **Melhorias na Auditoria**: Novo layout de detalhes para logs de operação, corrigindo problemas de informações cortadas.\n• **Navegação Inteligente**: Destaque visual (fundo e cor) para a aba ativa na barra lateral.",
        ["Changelog_v1_4_0"] = "• **Tipografia Personalizável**: Suporte a múltiplas fontes (Inter, Roboto, Montserrat, Open Sans, Public Sans e JetBrains Mono).\n• **Ajustes em Tempo Real**: Alterações de tema, fonte e efeitos visuais agora são aplicadas instantaneamente sem reiniciar.\n• **Efeito Mica & Glass**: Suporte nativo ao Windows 11 Mica e AcrylicBlur com slider de opacidade variável para a barra lateral.\n• **Estabilidade de Interface**: Definido tamanho mínimo de janela (950x650) para garantir integridade visual.",
