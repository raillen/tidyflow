...
**AutoFlow** é uma solução desktop moderna e poderosa para automação de gestão de arquivos e pastas. Projetado para ser leve, rápido e intuitivo, ele permite que você crie fluxos de trabalho inteligentes que organizam, movem, copiam e fazem backup dos seus dados automaticamente.

![AutoFlow Logo](src/AutoFlow.App/Assets/app-icon.png)
...
- **Simulação (Dry-Run):** Veja exatamente o que o AutoFlow faria antes de aplicar qualquer alteração real nos seus arquivos.
...
5. **Ative:** Salve e deixe o AutoFlow trabalhar por você em background.
